...
const WEEK = [
  {
    ...
    shows: [
      ...
      { time: "22:10", title: "Золотой Запас" },
      { time: "23:00", title: "Dancefloor Files!" },
    ],
  },
  {
    day: "Пн", date: "6.07",
    shows: [
      ...
      { time: "03:00", title: "Rock Jams" },
      { time: "04:00", title: "Золотая Шкатулка" },
      { time: "07:00", title: "Non-stop: 90-е" },
      { time: "10:00", title: "Назад в 2000-й!" },
      { time: "12:00", title: "100% ЛЕТНИЙ ХИТ" },
      { time: "13:00", title: "Капсула Времени" },
      { time: "14:00", title: "Non-stop: 10-е" },
      { time: "16:00", title: "Rap & R'N'B jams" },
      { time: "17:00", title: "Гламурные 00-е" },
      { time: "19:00", title: "Flashbacks: 2010" },
  ...
  },
  {
    ...
    shows: [
      ...
      { time: "03:00", title: "Chill jams" },
      { time: "04:00", title: "Золотой Запас" },
      { time: "07:00", title: "Non–Stop: 90-е" },
      { time: "10:00", title: "Архивные Файлы: 2000" },
      { time: "11:00", title: "Угадай клип по году" },
      { time: "12:00", title: "Золотая Шкатулка" },
      { time: "14:00", title: "Капсула Времени" },
      { time: "15:00", title: "Глюк'Oza VS. Винтаж" },
      { time: "16:00", title: "Flashbacks: 2011" },
      { time: "17:00", title: "Гламурные 00-е" },
  ...
  },
  {
    ...
    shows: [
      { time: "00:00", title: "Золотая Шкатулка" },
      { time: "03:00", title: "Chill jams" },
      { time: "05:00", title: "Золотой Запас" },
      { time: "07:00", title: "Non–Stop: 90-е" },
      { time: "10:00", title: "Победитель битвы" },
      { time: "10:30", title: "Love Hits" },
      { time: "12:00", title: "Архивные Файлы: 2001" },
      { time: "13:00", title: "Капсула Времени" },
      { time: "14:00", title: "Назад в 2001-й!" },
      { time: "15:00", title: "Гости из будущего VS. Иванушки" },
      { time: "16:00", title: "Non–Stop: 10-е" },
      { time: "17:00", title: "Гламурные 00-е" },
      { time: "19:00", title: "Rap & R'N'B jams" },
      { time: "20:00", title: "Non–Stop: 00-е" },
      { time: "22:00", title: "Best Hits: 2009" },
      { time: "23:00", title: "Dancefloor Files!" },
    ],
  },
  {
    ...
    shows: [
      { time: "00:00", title: "Золотой Запас" },
      { time: "03:00", title: "18+ блок" },
      { time: "04:00", title: "Золотая Шкатулка" },
      { time: "07:00", title: "Non–Stop: 10-е" },
      { time: "09:00", title: "Архивные Файлы: 2002" },
      { time: "10:00", title: "Победитель битвы" },
      { time: "10:30", title: "Угадай клип по году" },
      { time: "11:30", title: "100% ЛЕТНИЙ ХИТ" },
      { time: "13:00", title: "Капсула Времени" },
      { time: "14:00", title: "Музыкальный гороскоп" },
      { time: "15:00", title: "Праздник в каждый дом" },
      { time: "16:00", title: "Эволюция" },
      { time: "17:00", title: "Гламурные 00-е" },
      { time: "19:00", title: "ХИТ–ЛИСТ: по странам" },
      { time: "20:00", title: "Non–Stop: 00-е" },
      { time: "22:00", title: "Flashbacks: 2011" },
      { time: "23:00", title: "Chill jams" },
    ],
  },
  {
    day: "Сб", date: "11.07",
    shows: [
      ...
      { time: "04:00", title: "Золотой Запас" },
      { time: "07:00", title: "Non–Stop: 90-е" },
      { time: "09:00", title: "Топ–40: Ballads 00's" },
      { time: "12:00", title: "00's Weekend Hits!" },
      { time: "15:00", title: "Золотая Шкатулка" },
      { time: "18:00", title: "90's Weekend Hits!" },
      { time: "21:00", title: "Rock Jams" },
      { time: "22:00", title: "Get the party started!" },
    ],
  },
  {
    day: "Вс", date: "12.07",
    shows: [
      { time: "00:00", title: "Золотой Запас" },
      { time: "03:00", title: "18+ блок" },
      { time: "04:00", title: "Hot weekend!" },
      { time: "06:00", title: "Золотая Шкатулка" },
      { time: "08:00", title: "Non–Stop: 90-е" },
      { time: "12:00", title: "Non–Stop: 00-е" },
      { time: "17:00", title: "Золотая Шкатулка" },
      { time: "21:00", title: "Get the party started!" },
      { time: "23:00", title: "Chill jams" },
    ],
  },
];
